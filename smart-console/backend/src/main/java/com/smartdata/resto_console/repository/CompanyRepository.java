...
public interface CompanyRepository extends JpaRepository<Company, Integer> {
    ...
    @Param("p_branch_tel_no") String branch_tel_no, @Param("p_email") String email, @Param("p_logo_filename") String logo_filename, 
    @Param("p_dinein_count") Integer dinein_count, 
