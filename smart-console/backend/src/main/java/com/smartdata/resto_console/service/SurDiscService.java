...
public class SurDiscService {
    ...
    String active_flag, Integer sm_discount_type, String pcnt_on_nv_flag) {
    ...
    String check_senior, String active_flag, Integer sm_discount_type, String pcnt_on_nv_flag) {
