...
public class CompanyService {
    ...
    public void updateCompany(Integer id, String cmpy_nm, String operated_by, String tin_no, String address1, String address2, String roller_txt, String branch_manager, 
        String branch_tel_no, String email, String logo_filename, Integer dinein_count, Integer pickup_count, Integer dlvry_count, String send_to_kitchen, String track_invty_flag) {
        cmpyRepository.updateCompany(id, cmpy_nm, operated_by, tin_no, address1, address2, roller_txt, branch_manager, branch_tel_no, email, logo_filename, dinein_count, pickup_count, dlvry_count, send_to_kitchen, track_invty_flag);
    }
