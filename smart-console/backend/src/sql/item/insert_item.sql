...
BEGIN 
    ...
    INSERT INTO public.item (
        ...
        send_to_printer_flag, allow_dinein_flag, allow_pickup_flag, allow_delivery_flag, soldout_flag,
        ...
        p_send_to_printer_flag, p_allow_dinein_flag, p_allow_pickup_flag, p_allow_delivery_flag, p_soldout_flag,
        p_lastupduserid, NOW()
    );
END; 
$BODY$;
